...
CPU_FLAGS  +=-muclibc -EL -mips32r2 -mfp64 -mmsa -mabs=2008 -mnan=2008 -Os

else ifeq (${PLATFORM_NAME}, JZT41)
export COMPILER_NAME=mips-t41-linux-gnu
export COMPILER_PREFIX=mips-t41-linux-gnu-
CPU_FLAGS  +=-muclibc -march=mips32r2 -EL -mfp64 -mmsa -mabs=2008 -mnan=2008 -Os
...
ifeq (${DEBUGIT},y)
OPT_FLAGS:=-g -fno-omit-frame-pointer -rdynamic -mapcs-frame -Wall -fPIC -pthread
else
