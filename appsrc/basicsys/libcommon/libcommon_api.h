...
#define Common_Trace_RetFree(lpTrace) \
	...
	LIBCOMMON_API S32 Common_Linux2CommonGmTime(time_t linux_time, Common_Time_T *pCommon_time);
	LIBCOMMON_API S32 Common_CommonGm2LinuxTime(Common_Time_T *pCommon_time, time_t *plinux_time);
	LIBCOMMON_API S32 Common_Common2LinuxTime(Common_Time_T *pCommon_time, time_t *plinux_time);
	LIBCOMMON_API S32 Common_GetTimeDiff();
...
/**==========================================================
 * @brief Common_DList_UpdateNode
 * @note  更新匹配的节点数据，如果没有匹配的节点则插入节点，请注意返回结果
 * @remarks
 * @details
 * @param dlistHandle
 * @param data
 ...
 *
 * =========================================================*/
    LIBCOMMON_API S32 Common_DList_UpdateNode(COMMON_DLIST_T dlistHandle, void *data, int size,
                                              COMMON_LIST_COMPARE_F cb);
