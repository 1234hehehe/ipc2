...
${TARGET_DLIB}:${OBJS}
	...
	$(call COMPILE_DLIB)
export_files:
	@mkdir -p ${OUT_PATH}/lib ${OUT_PATH}/inc
	cp -af ${TARGET_SLIB} ${OUT_PATH}/lib
	cp -af ${TARGET_DLIB} ${OUT_PATH}/lib
	@if [ -n "${INC_FILE_EXPORT}" ] ; then echo "cp -af ${INC_FILE_EXPORT} ${OUT_PATH}/inc"; cp -af ${INC_FILE_EXPORT} ${OUT_PATH}/inc; fi
