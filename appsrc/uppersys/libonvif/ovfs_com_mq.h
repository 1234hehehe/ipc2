 ...
 * 返回:
 */
typedef void (*MQ_DATA_F)(unsigned int id, unsigned int ipcDataType,
                          unsigned int ipcDataToken, void *data, unsigned int size);
 ...
 * 返回:
 */
typedef void (*MQ_REQ_F)(unsigned int id, void *reqInData,
 ...
 *              <0     -  失败
 */
int Mq_PostMsg(MQ_HANDLE_H mqHandle, unsigned int id, void *data,
               unsigned int size);
