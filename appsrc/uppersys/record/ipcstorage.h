#ifndef IPC_STORAGE_API_H
#define IPC_STORAGE_API_H


#include "time.h"
#include "pkgstreamstorage.h"
//#include "cv_ipc_api.h"
...
// 最大录像文件路径长度
#define MAX_REC_FILE_NAME_LEN	(64)
...
#define	CV_RECORD_EVENT			(2)
#define	CV_RECORD_MANUAL			(7)

#define 	CV_RECORD_END				(13)
#else
#define 	CV_RECTYPE_BEGIN			(0)
#define	CV_RECTYPE_TIMER			(1)
#define	CV_RECTYPE_MOTION			(2)
#define	CV_RECTYPE_ALARM			(3)
#define	CV_RECTYPE_MOTIONORALARM	(4)
#define	CV_RECTYPE_MOTIONANDALARM	(5)
#define	CV_RECTYPE_COMMAND			(6)
#define	CV_RECTYPE_MANUAL			(7)
#define	CV_RECTYPE_ALL				(8)
#define	CV_RECTYPE_IVSDETECT		(9)
#define	CV_RECTYPE_FACE_DETECT		(10)
#define	CV_RECTYPE_FIRE_DETECT		(11)
#define	CV_RECTYPE_VIDEODIAGNOSE	(12)

#define 	CV_RECTYPE_END				(13)
#endif
////////////////////////////////////////////////////////////////////////////////
// 枚举定义
////////////////////////////////////////////////////////////////////////////////
...
{
	char acDeviceId[32];					// 设备id，ants的设备一般传入设备序列号
}RecDeviceId;
...
/*录像片断信息结构体*/
typedef struct _PSS_REGSEG_EX
{
    time_t             tBeginTime; //起始时间点
    time_t             tEndTime;   //结束时间点
    int                iRecType;   //该时间段的录像类型
    int				   iIndexNum;    //录像索引序号
    struct _PSS_REGSEG_EX *ptNext;
} PSS_REGSEG_EX, *pPPS_REGSEG_EX;
...
* \return 存储库不检查该回调函数的返回值
*/
typedef int (*ANTS_AVI_DATAPOP_CALLBACK)(HANDLE hDataPopper, int iChannel, BOOL bIndexFrame, unsigned short wFrameType, time_t tFrameTime, unsigned char *pBuf, unsigned int dwSize, unsigned int EventID, void *pContext);
...
* \return 成功返回0，失败的错误码请参考cv_avis_ret_code
*/
